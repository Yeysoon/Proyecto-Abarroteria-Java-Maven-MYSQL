...
<html>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="modal" id="modal_eliminarProveedor">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">     
                        ...
                        <form action  ="sr_proveedores_eliminar" method="post">
                            ...
                            <button name="btn_eliminar" id="btn_eliminar" type="submit" value= "eliminar" class="btn btn-primary"onclick="javascript:if (!confirm('¿Quiere eliminar el proveedor?'))
