            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="bg-dark p-4 text-white rounded">
                        ...
                        <form action  ="sr_empleados" method="post">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="dpi" name="dpi" placeholder="Codigo" required>
                            </div>
                            <div class="mb-3">
                                <label for="fechaNacimiento" class="form-label">Fecha de Nacimiento</label>
                                <input type="date" class="form-control" id="fechaNacimiento" name="fechan">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="direccion" name="direcc" placeholder="Dirección">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="telefono" name="tel" placeholder="Teléfono">
                            </div>
                            <div class="mb-3">
                            ...
                            <button name="btn_agregar" id="btn_agregar"  value= "agregar" type="submit" class="btn btn-primary" onclick="javascript:if (!confirm('¿Confirma datos del empleado?'))
                                    return false">Ingresar Datos</button>
                        </form>
                    </div>
                </div>
            </div>
