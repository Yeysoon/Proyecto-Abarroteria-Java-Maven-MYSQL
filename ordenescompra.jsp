...
<html lang="en">
    <head>
        ...
        <title>Formulario de Órdenes de Compra</title>
        ...
        <div class="container mt-4">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    ...
                    <form action="sr_ordenescompra" method="post" >
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="IDProveedor" name="IDProveedor" class="form-control">
                                <%
                                    ...
                                    HashMap<String, String> dropProveedor = proveedor.drop_sangre();
                                    for (String i : dropProveedor.keySet()) {
                                        out.println("<option value='" + i + "'>" + dropProveedor.get(i) + "</option>");
                                    }
                                %>
                            </select>
                        </div>
