...
<html lang="en">
    <head>
        ...
        <title>Formulario de Detalle de Factura</title>
    ...
    <div class="container mt-4">
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <h2>Formulario de Detalle de Factura</h2>
                <form action="sr_detalle_factura" method="post" class="bg-white rounded p-4">
                    <div class="mb-3">
                        <label for="IDFactura" class="form-label">ID Factura</label>
                        <select id="IDFactura" name="IDFactura" class="form-control" readonly>
                            <%
                                Facturas factura = new Facturas();
                                HashMap<String, String> dropFactura = factura.drop_sangre();
                                for (String i : dropFactura.keySet()) {
                                    out.println("<option value='" + i + "'>" + dropFactura.get(i));
                                }
                            %>
                        </select>
                    </div>
