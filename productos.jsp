...
<%@ page import="controlador.sr_productos" %>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="bg-dark p-4 text-white rounded">
                        ...
                        <form action="sr_productos" method="post">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control" id="PrecioVenta" name="PrecioVenta" required oninput="updateStockPrice();">
                            </div>
                            <div class="mb-3">
                                <label for="StockActual" class="form-label">Stock Actual</label>
                                <input type="number" class="form-control" id="StockActual" name="StockActual" required oninput="updateStockPrice();">
                            </div>
                            <div class="mb-3">
                                <label for="StockActualPrecio" class="form-label">Precio Stock Actual</label>
                                <input type="number" step="0.01" class="form-control" id="StockActualPrecio" name="StockActualPrecio" readonly> 
                            </div>
                            <button name="btn_agregar" value="agregar" type="submit" class="btn btn-primary">Agregar Producto</button>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <script>
            function updateStockPrice() {
                ...
                var stockActual = parseFloat(document.getElementById('StockActual').value) || 0;

                // Compute the total stock price
                var total = precioVenta * stockActual;

                document.getElementById('StockActualPrecio').value = total.toFixed(2);
            }
        </script>
