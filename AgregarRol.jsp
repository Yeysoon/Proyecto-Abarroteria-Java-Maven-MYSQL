    ...
    <body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action  ="sr_usuariorol" method="post">
                            <div class="mb-3">
                                <label for="txt_id" class="form-label">ID USUARIO</label>
                            ...
                            <div class="mb-3">
                                ...
                                <%
                                    Roles rol = new Roles();
                                    HashMap<String, String> droprol = rol.drop_sangre();
                                    for (String i : droprol.keySet()) {
                                        out.println("<option value='" + i + "'>" + droprol.get(i) + "</option>");
                                    }
                                %>
                                 </select>
                            </div>
                            ...
                            <button name="btn_modificar" id="btn_modificar" type="submit" value= "modificar" class="btn btn-primary" onclick="javascript:if (!confirm('¿Confirma los cambios?'))
        ...
        <script type="text/javascript">
                            $('#tbl_usuarios').on('click', 'tr td', function (evt) {
                                var target, txt_id;    //propias variables
                                target = $(event.target);

                                txt_id = target.parent("tr").find("td").eq(0).html();
                                $("#txt_id").val(txt_id);
                                $("#modal_usuario").modal('show');  //aqui colocamos el modal id
                            });
        </script>    
