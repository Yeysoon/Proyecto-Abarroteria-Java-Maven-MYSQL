            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="bg-dark p-4 text-white rounded">
                        ...
                        <form action="sr_clientes" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="telefono" name="tel" placeholder="Teléfono" required>
                            </div>
                            <div class="form-group">
                            ...
                            <button name="btn_agregar" type="submit" id="btn_agregar" value="agregar" class="btn btn-primary" onclick="javascript:if (!confirm('¿Confirma la Creación de Cliente?'))
