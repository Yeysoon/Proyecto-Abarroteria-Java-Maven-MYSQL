            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="bg-dark p-4 text-white rounded">
                        <h2>CREAR ROLL</h2>
                        <form action="sr_roles" method="post">
                            <div class="form-group">
                                <label for="nombre">Nombre ROLL:</label>
                                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" required>
                            </div>
                            <button name="btn_agregar" type="submit" id="btn_agregar" value="agregar" class="btn btn-primary" onclick="javascript:if (!confirm('¿Confirma la Creación del Roll?'))
