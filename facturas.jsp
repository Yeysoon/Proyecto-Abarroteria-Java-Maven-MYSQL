        ...
        <div class="container mt-4">
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    ...
                    <form action="sr_facturas" method="post" class="bg-white rounded p-4">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="NumeroFactura" name="NumeroFactura" placeholder="Número de Factura" required>
                        </div>
                        <div class="mb-3">
                            <label for="Cliente">Cliente</label>
                            <select id="IDCliente" name="IDCliente" class="form-control">
                                <%
                                    Clientet cliente = new Clientet();
                                    HashMap<String, String> dropCliente = cliente.drop_sangre();
                        ...
                        <div class="mb-3">
                            ...
                            <select  id="empleados_id" name="empleados_id" class="form-control">
                                <%
                                    Empleados empleado = new Empleados();
                                    HashMap<String, String> dropEmpleado = empleado.drop_sangre();
