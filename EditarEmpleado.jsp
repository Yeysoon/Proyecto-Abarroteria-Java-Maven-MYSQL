 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action  ="sr_empleados_editar" method="post">
                            <div class="form-group">
                                <div class="mb-3">
                                    <label for="id" class="form-label">ID</label>
                                    <input type="text" class="form-control" id="text_id" name="text_id" value="0" readonly>
                                </div>
                            ...
                            <button name="btn_modificar" id="btn_modificar" type="submit" value= "modificar" class="btn btn-primary" onclick="javascript:if (!confirm('¿Quiere guardar los cambios?'))
        ...
        <script type="text/javascript">
                            $('#tbl_empleados').on('click', 'tr td', function (evt) {
                                var target, text_id, nombre, dpi, fecha, genero, direc, ciudad, tel, email, cargo;    //propias variables
                                target = $(event.target);
                                text_id = target.parent("tr").find("td").eq(0).html();
                                nombre = target.parent("tr").find("td").eq(1).html();
                                dpi = target.parent("tr").find("td").eq(2).html();
                                fecha = target.parent("tr").find("td").eq(3).html();
                                genero = target.parent("tr").find("td").eq(4).html();
                                direc = target.parent("tr").find("td").eq(5).html();
                                ciudad = target.parent("tr").find("td").eq(6).html();
                                tel = target.parent("tr").find("td").eq(7).html();
                                email = target.parent("tr").find("td").eq(8).html();
                                cargo = target.parent("tr").find("td").eq(9).html();
                                ...
                                $("#fechan").val(fecha);
                                $("#genero").val(genero);
                                $("#direcc").val(direc);  //en el parentecis va el id del label del html
                                $("#ciudad").val(ciudad);
                                $("#tel").val(tel);
                                $("#email").val(email);
                                $("#cargo").val(cargo);
                                $("#modal_cliente").modal('show');  //aqui colocamos el modal id
                            });
        </script>    
    </body>
</html>