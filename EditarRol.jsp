...
<html>
    ...
    <body>
        ...
        <div class="modal" id="modal_editarrol">
            <div class="modal-dialog">
                <div class="modal-content">

                    <!-- Modal Header -->
                    <div class="modal-header">
                        <h4 class="modal-title">Editar Roll</h4>
                    ...
                    <div class="modal-body">     
                        ...
                        <form action  ="sr_editar_rol" method="post">
                            ...
                            <button name="btn_modificar" id="btn_eliminar" type="submit" value= "modificar" class="btn btn-primary"onclick="javascript:if (!confirm('¿Quiere Guardar cambios?'))return false">Modificar</button>
   ...
   <!-- script para el evento click -->
        <script type="text/javascript">
                      $('#tbl_rol').on('click', 'tr td', function (evt) {
                          var target, id, nombre;    //propias variables
                          target = $(event.target);
