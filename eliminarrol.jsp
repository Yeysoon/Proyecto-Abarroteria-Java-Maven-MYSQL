...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="modal" id="modal_eliminarrol">
            <div class="modal-dialog">
                <div class="modal-content">

                    <!-- Modal Header -->
                    <div class="modal-header">
                        <h4 class="modal-title">Eliminar Roll</h4>
                    ...
                    <div class="modal-body">     
                        ...
                        <form action  ="sr_eliminar_rol" method="post">
   ...
   <!-- script para el evento click -->
        <script type="text/javascript">
                      $('#tbl_roles').on('click', 'tr td', function (evt) {
