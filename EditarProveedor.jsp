...
<html>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action  ="sr_proveedores_editar" method="post">
                            <div class="form-group">
                                <label for="nombre">Id:</label>
                                <input type="text" class="form-control" id="txt_id" name="id" value="0" readonly>
                            </div>
                            <div class="form-group">
        ...
        <div class="container">
            ...
            <p>Maestra de datos Proveedores:</p> 
        ...
        <script type="text/javascript">
                            $('#tbl_proveedores').on('click', 'tr td', function (evt) {
                                ...
                                $("#correo").val(correoelectronico);  //en el parentecis va el id del label del html
                                $("#nit").val(nit);
                                $("#estado").val(estado);
