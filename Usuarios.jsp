   ...
   <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action  ="sr_usuarios" method="post">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="id_empleado" readonly>
                            </div>

                            <button name="btn_agregar" id="btn_agregar" type="submit" value= "agregar" class="btn btn-primary" onclick="javascript:if (!confirm('¿Confirma la creacion del usuario?'))
                                        return false">Crear</button>
        ...
        <script type="text/javascript">
                                $('#tbl_empleados').on('click', 'tr td', function (evt) {
                                    var target, usuario, email, password, id_empleado;    //propias variables
                                    target = $(event.target);
